      ...
      <nav className=" w-full">
        ...
        >
          <div className=" hidden   md:block ">
            ...
            >
              <AcademicCapIcon className="h-15 w-10 text-black md:text-white bg-blue-400 rounded-xl hover:bg-white hover:text-blue-400 transition delay-150 duration-300 ease-in-out"></AcademicCapIcon>
          ...
          <div className=" flex  flex-col md:flex-row gap-6 mt-2  bg-blue-300 rounded-lg md:bg-transparent p-10 md:p-0">
            <Link
              className="font-bold hover:text-blue-500 text-black md:text-white border border-white bg-white md:bg-transparent md:border-0  rounded-lg text-center transition delay-150 duration-150 ease-in-out"
              to="/"
            >
              Home
            </Link>
