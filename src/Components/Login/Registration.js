...
<label htmlFor="exampleInputEmail1" className="form-label inline-block mb-2 text-black">Enter Your Full Name</label>
...
<div className="form-group mb-6">
<label htmlFor="exampleInputEmail1" className="form-label inline-block mb-2 text-black">Photo URL</label>
...
<div className="form-group mb-6">
<label htmlFor="exampleInputEmail1" className="form-label inline-block mb-2 text-black">Email address</label>
...
<div className="form-group mb-6">
<label htmlFor="exampleInputPassword1" className="form-label inline-block mb-2 text-black">Password</label>
